...
<head>
    ...
    <style>
        ...
        .galley_view {
            ...
            text-align: center; /* Centrar contenido dentro de .galley_view */
        ...
        .galley_view_notice {
            ...
            border: 1px solid #ffc107;
            border-radius: 4px;
            text-align: center; /* Centrar mensaje de aviso */
        }
