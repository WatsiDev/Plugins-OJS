...
{include file=$displayTemplateResource title=$submission->getLocalizedTitle()|escape parentUrl=$parentUrl|escape pdfUrl=$pdfUrl|escape galleyTitle=$galleyTitle|escape datePublished=$datePublished|escape}
