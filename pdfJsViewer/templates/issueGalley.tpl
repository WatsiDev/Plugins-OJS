...
{include file=$displayTemplateResource title=$issue->getIssueIdentification()|escape parentUrl=$parentUrl|escape pdfUrl=$pdfUrl|escape galleyTitle=$galleyTitle|escape datePublished=$datePublished|escape}
